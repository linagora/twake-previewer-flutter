...
enum ZoomState { activate, inactivate }

class PdfPaginationWidget extends StatefulWidget {
  final PdfViewerController? pdfViewerController;
  final String? pageText;
  final String? zoomInTooltip, zoomOutTooltip;

  const PdfPaginationWidget({
    super.key,
  ...
  @override
  State<PdfPaginationWidget> createState() => _PdfPaginationWidgetState();
}

class _PdfPaginationWidgetState extends State<PdfPaginationWidget> {
  static const double _maxZoomLevelDefault = 4.0;
  static const double _minZoomLevelDefault = 1.0;

  final ValueNotifier<ZoomState> _zoomInPageNotifier =
      ValueNotifier<ZoomState>(ZoomState.activate);
  final ValueNotifier<ZoomState> _zoomOutPageNotifier =
      ValueNotifier<ZoomState>(ZoomState.inactivate);
  ...
  void _pageChanged({String? property}) {
    _pageCurrentNotifier.value =
        widget.pdfViewerController?.currentPageNumber ?? 1;
    _updateZoomState();
  }
